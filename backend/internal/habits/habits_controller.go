...
// @Accept       json
// @Produce      json
// @Param        body body criarHabitoRequest true "Dados do hábito"
...
// @Param        body body editarHabitoRequest true "Campos a atualizar"
// @Success      200 {object} map[string]interface{}
...
// @Produce      json
// @Param        id   path string       true "ID do hábito"
// @Param        body body toggleRequest true "Data"
// @Success      200 {object} map[string]interface{}
// @Security     BearerAuth
