...
// @Tags         Goals
// @Produce      json
// @Param        scope query string false "annual ou monthly"
...
// @Accept       json
// @Produce      json
// @Param        body body criarMetaRequest true "Dados da meta"
...
// @Param        body body editarMetaRequest true "Campos a atualizar"
// @Success      200 {object} map[string]interface{}
...
// @Produce      json
// @Param        id   path string                    true "ID da meta"
// @Param        body body atualizarProgressoRequest true "Valor atual"
// @Success      200 {object} map[string]interface{}
// @Failure      404 {object} map[string]string
// @Security     BearerAuth
