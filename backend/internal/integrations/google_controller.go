...
// @Security     BearerAuth
// @Router       /integrations/google [delete]
...
// @Security     BearerAuth
// @Router       /integrations/google/events [get]
...
// @Accept       json
// @Produce      json
// @Param        body body criarEventoGoogleRequest true "Dados do evento"
// @Success      200 {object} map[string]interface{}
// @Security     BearerAuth
// @Router       /integrations/google/events [post]
