...
// @Security     BearerAuth
// @Router       /integrations/outlook/connect [get]
...
// @Security     BearerAuth
// @Router       /integrations/outlook [delete]
...
// @Accept       json
// @Produce      json
// @Param        body body criarEventoOutlookRequest true "Dados do evento"
// @Success      200 {object} map[string]interface{}
// @Security     BearerAuth
// @Router       /integrations/outlook/events [post]
