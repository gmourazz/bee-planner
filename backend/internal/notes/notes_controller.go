...
// @Accept       json
// @Produce      json
// @Param        body body criarNotaRequest true "Dados da nota"
...
// @Param        body body editarNotaRequest true "Campos a atualizar"
// @Success      200 {object} map[string]interface{}
...
// @Produce      json
// @Param        id   path string          true "ID da nota"
// @Param        body body togglePinRequest true "isPinned"
// @Success      200 {object} map[string]interface{}
// @Security     BearerAuth
